...
----------------------------------add data to users -------------------------------------------
Insert into users(firstname,lastname,email,phonenumber,gender,avatar)
Values('mark','kass','user1@fpt.edu.vn',012345678,0,'images/girl.jpg'),
('john','viet','user2@fpt.edu.vn',045865893,1,'images/boy.jpg'),
('gary','bass','user3@fpt.edu.vn',0675978234,1,'images/boy.jpg')
